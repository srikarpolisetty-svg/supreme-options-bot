...
def ingest_option_snapshot_5w(symbol: str):
    ...
    INSERT INTO option_snapshots_raw_5w (
        snapshot_id, timestamp, symbol, option_symbol, strike, call_put,
        days_to_expiry, expiration_date, moneyness_bucket,
        bid, ask, mid, volume, open_interest, iv, spread, spread_pct, time_decay_bucket
    )
    VALUES
        (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?),
        (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?),
    ...
    atm_call_z, atm_call_vol_z, atm_call_iv_z = compute_z_scores_for_bucket_5w(
        con, symbol=symbol, bucket="ATM", call_put="C", time_decay_bucket=time_decay_bucket,
        current_mid=atm_call_mid, current_volume=atm_call_volume, current_iv=atm_call_iv
    )
    atm_put_z, atm_put_vol_z, atm_put_iv_z = compute_z_scores_for_bucket_5w(
        con, symbol=symbol, bucket="ATM", call_put="P", time_decay_bucket=time_decay_bucket,
        current_mid=atm_put_mid, current_volume=atm_put_volume, current_iv=atm_put_iv
    )
    otm_call_1_z, otm_call_1_vol_z, otm_call_1_iv_z = compute_z_scores_for_bucket_5w(
        con, symbol=symbol, bucket="OTM_1", call_put="C", time_decay_bucket=time_decay_bucket,
        current_mid=otm_call_1_mid, current_volume=otm_call_1_volume, current_iv=otm_call_1_iv
    )
    otm_put_1_z, otm_put_1_vol_z, otm_put_1_iv_z = compute_z_scores_for_bucket_5w(
        con, symbol=symbol, bucket="OTM_1", call_put="P", time_decay_bucket=time_decay_bucket,
        current_mid=otm_put_1_mid, current_volume=otm_put_1_volume, current_iv=otm_put_1_iv
    )
    otm_call_2_z, otm_call_2_vol_z, otm_call_2_iv_z = compute_z_scores_for_bucket_5w(
        con, symbol=symbol, bucket="OTM_2", call_put="C", time_decay_bucket=time_decay_bucket,
        current_mid=otm_call_2_mid, current_volume=otm_call_2_volume, current_iv=otm_call_2_iv
    )
    otm_put_2_z, otm_put_2_vol_z, otm_put_2_iv_z = compute_z_scores_for_bucket_5w(
        con, symbol=symbol, bucket="OTM_2", call_put="P", time_decay_bucket=time_decay_bucket,
        current_mid=otm_put_2_mid, current_volume=otm_put_2_volume, current_iv=otm_put_2_iv
    )
